    ...
    return(
        <div>
            ...
            <Router>
                ...
                <Landing user={user} setUser={setUser} path="/landing/:userEmail"/>
                <ArtistPage user={user} setUser={setUser} path="/artist/:artistId/:userEmail"/> 
                ...
                <UserProfile user={user} setUser={setUser} path="/user/:userEmail"/>
